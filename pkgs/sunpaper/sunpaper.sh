...
#
wallpaperPath="/home/ola/.background-images/Corporate-Synergy"
...
CONFIG_FILE=/home/ola/.config/sunpaper/config
...
setpaper_construct() {
  ...
  if [ "$swww_enable" == "true" ]; then
    ...
    feh --bg-scale "$wallpaperPath"/"$image".jpg
  fi
